            ...
            title: homePageController.isSearching
                ...
                : Row(
                    children: [
                      ...
                      InkWell(
                        onTap: () {
                          homePageController.loadCart(context,
                          ...
                          onPressed: () {
                            if (homePageController
                              ...
                              homePageController.performSearch(
                                  homePageController.searchController.text
                                      .trim());
                            }
                          },
                        ),
                          ...
                          children: [
                            ...
                            Padding(
                              ...
                              child: CarouselSlider(
                                ...
                                items:
                                    homePageController.imagePaths.map((item) {
                                  return Image.asset(
                                    item,
                ...
                RoleSwitcherFab(
                  ...
                  onPressed: () {
                    Provider.of<HomePageController>(
                            ...
                            listen: false)
                        .switchRole(
                            false, widget.onToggleDarkMode, widget.isDarkMode);
                  },
                ),
              ],
            ],
